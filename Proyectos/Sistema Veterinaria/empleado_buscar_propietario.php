...
// Obtener el id_paciente del formulario
$id_paciente = isset($_POST['id_paciente']) ? $_POST['id_paciente'] : '';

// Preparar y ejecutar la consulta SQL para buscar propietario por id_paciente
$sql = "SELECT * FROM propietarios WHERE id_paciente = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $id_paciente); // "i" indica que es un entero
$stmt->execute();
